...
// WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
import { CodeQualityController } from './../controller/CodeQualityController';
// WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
...
const models: TsoaRoute.Models = {
    ...
    "BranchDTO": {
        ...
        "properties": {
            ...
            "commitAutomaticSynchronization": {"dataType":"boolean","required":true},
            "fileAutomaticSynchronization": {"dataType":"boolean","required":true},
    ...
    "BranchPatchDTO": {
        "dataType": "refObject",
        "properties": {
            "commitAutomaticSynchronization": {"dataType":"boolean"},
            "fileAutomaticSynchronization": {"dataType":"boolean"},
        },
        "additionalProperties": false,
    },
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
    ...
    "CommitResponseDTO": {
        ...
        "properties": {
            ...
            "possiblyAffectedByForcePush": {"dataType":"boolean","required":true},
        },
        "additionalProperties": false,
    },
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
    ...
    "CommitSearchDTO": {
        ...
        "properties": {
            ...
            "possiblyAffectedByForcePush": {"dataType":"boolean"},
        },
        "additionalProperties": false,
    },
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
...
export function RegisterRoutes(app: Router) {
    ...
    // ###########################################################################################################
        app.get('/auth/public-key',
            ...
            ...(fetchMiddlewares<RequestHandler>(AuthController.prototype.getPublicKey)),

            function AuthController_getPublicKey(request: any, response: any, next: any) {
            const args = {
            };
            ...
            try {
              ...
              const promise = controller.getPublicKey.apply(controller, validatedArgs as any);
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        app.patch('/repository/:repositoryId/branch/:id',
            authenticateMiddleware([{"bearer":["admin"]}]),
            ...(fetchMiddlewares<RequestHandler>(BranchController)),
            ...(fetchMiddlewares<RequestHandler>(BranchController.prototype.patch)),

            function BranchController_patch(request: any, response: any, next: any) {
            const args = {
                    repositoryId: {"in":"path","name":"repositoryId","required":true,"dataType":"double"},
                    id: {"in":"path","name":"id","required":true,"dataType":"double"},
                    body: {"in":"body","name":"body","required":true,"ref":"BranchPatchDTO"},
            };
        ...
        app.post('/code-quality/repository/:repositoryId',
            ...
            function CodeQualityController_create(request: any, response: any, next: any) {
            const args = {
                    repositoryId: {"in":"path","name":"repositoryId","required":true,"dataType":"double"},
            };
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        app.delete('/consistency-rule/:id',
            authenticateMiddleware([{"bearer":["admin"]}]),
            ...(fetchMiddlewares<RequestHandler>(ConsistencyRuleController)),
            ...(fetchMiddlewares<RequestHandler>(ConsistencyRuleController.prototype.delete)),

            function ConsistencyRuleController_delete(request: any, response: any, next: any) {
            const args = {
                    id: {"in":"path","name":"id","required":true,"dataType":"double"},
            };
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        app.post('/evaluation-method/:id/clone',
            authenticateMiddleware([{"bearer":["admin"]}]),
            ...(fetchMiddlewares<RequestHandler>(EvaluationMethodController)),
            ...(fetchMiddlewares<RequestHandler>(EvaluationMethodController.prototype.clone)),

            function EvaluationMethodController_clone(request: any, response: any, next: any) {
            const args = {
                    id: {"in":"path","name":"id","required":true,"dataType":"double"},
            };
            ...
            try {
              ...
              const promise = controller.clone.apply(controller, validatedArgs as any);
              promiseHandler(controller, promise, response, 201, next);
            } catch (err) {
                return next(err);
            }
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        app.delete('/sprint/:id',
            authenticateMiddleware([{"bearer":["admin"]}]),
            ...(fetchMiddlewares<RequestHandler>(SprintController)),
            ...(fetchMiddlewares<RequestHandler>(SprintController.prototype.delete)),

            function SprintController_delete(request: any, response: any, next: any) {
            const args = {
                    id: {"in":"path","name":"id","required":true,"dataType":"double"},
            };
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        app.delete('/standardized-issue/:id',
            authenticateMiddleware([{"bearer":["admin"]}]),
            ...(fetchMiddlewares<RequestHandler>(StandardizedIssueController)),
            ...(fetchMiddlewares<RequestHandler>(StandardizedIssueController.prototype.delete)),

            function StandardizedIssueController_delete(request: any, response: any, next: any) {
            const args = {
                    id: {"in":"path","name":"id","required":true,"dataType":"double"},
            };
        ...
        app.patch('/sync',
            ...
            ...(fetchMiddlewares<RequestHandler>(SyncController.prototype.sync)),

            function SyncController_sync(request: any, response: any, next: any) {
            const args = {
                    repositoryId: {"in":"query","name":"repositoryId","required":true,"dataType":"array","array":{"dataType":"double"}},
